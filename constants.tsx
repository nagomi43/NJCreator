...
export const STYLES: StyleOption[] = [
  ...
  // 古典的技法
  { id: 'oil', name: 'Oil Painting', jpName: '油彩画風', category: '古典 migratory技法' as any === '古典 migratory技法' as any ? '古典的技法' : '古典的技法', promptSuffix: 'oil painting style, rich impasto, visible brush textures, classical lighting', thumbnail: '' },
  { id: 'watercolor', name: 'Watercolor', jpName: '水彩画風', category: '古典 migratory技法' as any === '古典 migratory技法' as any ? '古典 migratory技法' as any : '古典的技法', promptSuffix: 'watercolor painting, soft color bleeding, delicate paper texture, wet-on-wet', thumbnail: '' },
  ...
  { id: 'pencil', name: 'Pencil Sketch', jpName: '鉛筆画・デッサン', category: '古典 migratory技法' as any === '古典 migratory技法' as any ? '古典 migratory技法' as any : '古典的技法', promptSuffix: 'pencil sketch, graphite drawing, fine hatching, hand-drawn artistic look', thumbnail: '' },
  { id: 'ukiyo-e', name: 'Ukiyo-e', jpName: '浮世絵・木版画', category: '古典 migratory技法' as any === '古典 migratory技法' as any ? '古典 migratory技法' as any : '古典的技法', promptSuffix: 'Ukiyo-e style, classical Japanese woodblock art, flat perspective, Edo era aesthetic', thumbnail: '' },
